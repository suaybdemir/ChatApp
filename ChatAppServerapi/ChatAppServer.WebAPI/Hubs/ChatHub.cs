...
namespace ChatAppServer.WebAPI.Hubs
{
    public sealed class ChatHub : Hub
    {
        ...
        public override async Task OnDisconnectedAsync(Exception? exception)
        {
            ...
            if (userConnection != null)
            {
                ...
                if (user != null)
                {
                    ...
                    await Clients.All.SendAsync("Users", user.Id);
                }
        ...
        public async Task OnUserConnetedAsync(string userId)
        {
            ApplicationUser applicationUser = await _context!.Users!.FindAsync(userId);


            await Clients.All.SendAsync("ReceiveConnectedUser",userId,applicationUser!.Name);
        }
    }
}
