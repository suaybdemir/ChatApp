...
namespace ChatAppServer.WebAPI.Controllers
{
        ...
        ): ControllerBase
    {
        ...
        {
            ApplicationUser applicationUser = await _context!.Users!.Where(u=>u.Name==name).FirstOrDefaultAsync();


            await _hubContext.Clients.All.SendAsync("ReceiveConnectedUser", applicationUser.Id, applicationUser!.Name);
