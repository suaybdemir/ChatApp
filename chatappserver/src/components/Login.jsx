    ...
    return (
        <Box className="login-box" sx={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "20px", borderRadius: "20px" }}>
            <Stack sx={{ width: "75%" }} spacing={2}>
                ...
                <TextField value={inputContent} onChange={(e) => setInputContent(e.target.value)} className='login-input' sx={{ width: "100%", backgroundColor: "white" }} id="outlined-basic" label="Username" variant="filled" />
